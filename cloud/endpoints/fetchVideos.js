...
/**
 * NodeJS Module: Encapsulates logic for fetchVideos Endpoint.
 * 
 */

var fetchVideosEndpoint = function() {
    
    /**
     * Process fetchVideos request.
     */
    // Exposed operations
    this.fetchVideos = function fetchVideos(reqJson, callback){
        ...
        sessionManager.getSession(sessionId, function(err, data ){
            ...
            if(data)
            {
                //Setting the apiSession to fetch the Videos details      
...
module.exports = new fetchVideosEndpoint();