...
define(['jquery',
    ...
    return ContainerView.extend({
        ...
        home: function() {
            ...
            this.$('#ads').show();
            var home = this.$nav.find('li#home').find('img')[0];
            $(home).attr('src', 'img/nav/HomeDark.png');
        ...
        widgets: function() {
            ...
            this.$('#ads').show();
            var widget = this.$nav.find('li#widgets').find('img')[0];
            $(widget).attr('src', 'img/nav/WidgetsDark.png');
        ...
        healthHub: function() {
            ...
            this.$('#ads').show();
            var hub = this.$nav.find('li#healthHub').find('img')[0];
            $(hub).attr('src', 'img/nav/HubDark.png');
        ...
        medicine: function() {
            ...
            this.$('#ads').hide();
            var med = this.$nav.find('li#medicine').find('img')[0];
            $(med).attr('src', 'img/nav/CabinetDark.png');
        ...
        calendar: function() {
            ...
            this.$('#ads').show();
            var cal = this.$nav.find('li#calendar').find('img')[0];
            $(cal).attr('src', 'img/nav/CalendarDark.png');
        ...
        library: function() {
            ...
            this.$('#ads').show();
            var library = this.$nav.find('li#library').find('img')[0];
            $(library).attr('src', 'img/nav/LibraryDark.png');
        }
    });
