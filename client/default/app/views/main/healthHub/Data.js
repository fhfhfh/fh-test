...
define(['jquery',
	...
	return Backbone.View.extend({
		...
		showFilter: function(){
			var self = this;
			var body = "<input type='checkbox' checked name='measure' value='true' id='measure'/><label data-id='measurements' class='checked' for='measure'>Measurements <img src='img/Search.png'/></label><input type='checkbox' checked name='results' value='true' id='results'/><label data-id='testResults' class='checked' for='results'>Test Results<img src='img/Search.png'/></label><input type='checkbox' checked name='immune' value='true' id='immune'/><label data-id='immunizations' class='checked' for='immune'>Immunizations<img src='img/Search.png'/></label>";
