...
define(['backbone'], function(Backbone) {
	...
	var journalDay = Backbone.Model.extend({
		...
		initialize: function() {
			console.log('Journal Day created', this.attributes);

			// initialize values
			if (!this.attributes.breakfast) {
				this.set("breakfast", [{
					calories: "0",
					location: "",
					"with": "",
